...
func (c *catalogServiceClient) GetSKUSnapshot(ctx context.Context, in *CatalogGetSKUSnapshotRequest, opts ...grpc.CallOption) (*CatalogGetSKUSnapshotResponse, error) {
	...
	out := new(CatalogGetSKUSnapshotResponse)
	err := c.cc.Invoke(ctx, CatalogService_GetSKUSnapshot_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CatalogService_GetSKUSnapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CatalogGetSKUSnapshotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CatalogServiceServer).GetSKUSnapshot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CatalogService_GetSKUSnapshot_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CatalogServiceServer).GetSKUSnapshot(ctx, req.(*CatalogGetSKUSnapshotRequest))
	}
